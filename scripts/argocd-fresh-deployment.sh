...
echo "3. Check TimescaleDB job: kubectl logs -f job/${ARGOCD_APP}-timescaledb-hypertable -n ${NAMESPACE}"
echo "4. Verify backend logs: kubectl logs -f -l app.kubernetes.io/component=backend -n ${NAMESPACE}"
